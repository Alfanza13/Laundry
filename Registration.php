    ...
    $sql = "SELECT * from user_registration where  User_Name='".$usrname."' and Contact_No='".$Contact_No."' ";
      $info = $db->query($sql);
          ...
          { 
            ...
            $insert = "insert into user_registration(User_Name,Father_Name,Address,Contact_No) 
             VALUES('".$usrname."','".$fname."','".$address."','".$Contact_No."')";
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="padding:35px 50px;">
          ...
          <h4><span class="glyphicon glyphicon-user"></span> Registrasi</h4>
        </div>
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form  role="form" method="post" action=""> 
            <div class="form-group">
             <label for="usrname"><span class="glyphicon glyphicon-user"></span> Nama Depan</label>
              <input type="text" class="form-control"
               id="usrname" required="" name="usrname" placeholder="Masukan Nama Depan">
            </div>

             <div class="form-group">
             <label for="psw"><span class="glyphicon glyphicon-user"></span> Nama Belakang (Opsional)</label>
              <input type="text" class="form-control" name="fname" optional="" placeholder="Masukan Nama Belakang">
            </div>
        ...
        <div class="modal-footer">
          <p><a href="index.php">Website Utama</a></p>
